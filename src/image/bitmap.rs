...
impl Bitmap {
    ...
    pub fn from_png_data(png_data: &[u8]) -> Result<Bitmap, String> {
        ...
        {
            let buffer_raw = crate::core::transmute_slice_to_byte_slice_mut(&mut buffer);
            png_reader
    ...
    pub fn write_to_png_file(&self, png_filepath: &str) {
        use platform::path_without_filename;
